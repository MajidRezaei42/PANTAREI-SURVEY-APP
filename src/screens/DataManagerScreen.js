...
const styles = StyleSheet.create({
  ...
  refreshTxt: { fontSize: 22, color: '#FFF' },
  headerTitle: { fontSize: 18, fontWeight: '700', color: '#FFF', flex: 1 },
  body: { padding: 14, paddingBottom: 40 },
  card: { backgroundColor: '#FFF', borderRadius: 12, padding: 14, marginBottom: 12, elevation: 2 },
  cardTitle: { fontSize: 15, fontWeight: '700', color: '#1A1814', marginBottom: 4 },
  ...
  total: { fontSize: 13, color: '#666', textAlign: 'right' },
  expBtn: { borderRadius: 10, padding: 14, marginBottom: 8 },
  expTxt: { fontSize: 15, fontWeight: '700', color: '#FFF' },
  expHint: { fontSize: 11, color: 'rgba(255,255,255,0.7)' },
  ...
  respId: { fontSize: 12, fontFamily: 'monospace', color: '#666', flex: 1 },
  respLang: { fontSize: 11, fontWeight: '700', color: '#1A3A6B' },
  respTime: { fontSize: 11, color: '#AAA' },
  chevron: { fontSize: 12, color: '#AAA' },
  detail: { marginTop: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#EEE' },
  detTitle: { fontSize: 11, fontWeight: '700', color: '#888', marginTop: 8, marginBottom: 3 },
  detVal: { fontSize: 12, color: '#444', fontFamily: 'monospace' },
  matrixHeader: { flexDirection: 'row', marginTop: 2 },
  matrixRow: { flexDirection: 'row', alignItems: 'center' },
  matrixCell: { fontSize: 12, fontFamily: 'monospace', textAlign: 'center', paddingVertical: 1 },
  matrixQ: { width: 44, textAlign: 'left', color: '#888', fontWeight: '700' },
  matrixHead: { flex: 1, fontWeight: '800' },
  matrixVal: { flex: 1, color: '#444' },
  dur: { fontSize: 11, color: '#AAA', marginTop: 10 },
  delBtn: { marginTop: 12, borderWidth: 1.5, borderColor: '#CC2020', borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
  delTxt: { fontSize: 14, fontWeight: '700', color: '#CC2020' },
});
