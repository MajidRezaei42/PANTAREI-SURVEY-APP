...
const styles = StyleSheet.create({
  ...
  stepLabel: { fontSize: 12, color: 'rgba(255,255,255,0.8)', marginBottom: 8 },
  ...
  cardTitle: { fontSize: 16, fontWeight: '700', color: '#1A1814', marginBottom: 8 },
  scaleHint: { fontSize: 12, color: '#999', fontStyle: 'italic', marginBottom: 10 },
  likertBlock: { borderRadius: 8, overflow: 'hidden', borderWidth: 1, borderColor: '#E8E8E8' },
  fieldLabel: { fontSize: 13, fontWeight: '600', color: '#444', marginTop: 14, marginBottom: 8 },
  req: { color: '#CC2020' },
  ...
  sbsGroup: { fontSize: 13, fontWeight: '700', letterSpacing: 0.5, marginBottom: 6, textTransform: 'uppercase' },
  sbsQuestion: { fontSize: 16, color: '#1A1814', lineHeight: 22, marginBottom: 8, fontWeight: '500' },
  sbsCode: { fontWeight: '800' },
  sliders: { marginTop: 4 },
  openLabel: { fontSize: 15, color: '#333', lineHeight: 21, marginBottom: 10, fontWeight: '500' },
  input: { borderWidth: 1, borderColor: '#DDD', borderRadius: 8, padding: 12, fontSize: 14, color: '#333', backgroundColor: '#FAFAFA', minHeight: 130, textAlignVertical: 'top', lineHeight: 20 },
  navRow: { flexDirection: 'row', gap: 10, marginTop: 4 },
  prevBtn: { flex: 1, borderWidth: 1.5, borderColor: '#BBB', borderRadius: 14, paddingVertical: 15, alignItems: 'center' },
  prevTxt: { fontSize: 15, fontWeight: '700', color: '#666' },
  ...
  discardTxt: { fontSize: 13, color: '#CC2020', textDecorationLine: 'underline' },
});
